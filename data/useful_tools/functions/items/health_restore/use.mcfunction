...
# スニーク・無敵OFF
    execute if entity @s[tag=C.Box_Invinsible,tag=!C.Toggled] if predicate useful_tools:sneak at @s run function useful_tools:items/health_restore/invinsible_off
