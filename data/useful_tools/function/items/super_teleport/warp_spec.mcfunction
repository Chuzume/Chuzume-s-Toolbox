...
# TPタグ付いてたらTP
    ...
    execute if entity @s[tag=C.Box_WarpTP] run playsound minecraft:entity.enderman.teleport player @s ~ ~ ~ 1 1
    execute if entity @s[tag=C.Box_WarpTP] run particle minecraft:portal ~ ~0.5 ~ 0.25 0.5 0.25 0 100 normal @s
