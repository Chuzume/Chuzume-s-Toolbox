...
# 目の前に何かあったらそこにTP
    ...
    execute unless block ^ ^ ^0.7 #useful_tools:no_collision run playsound minecraft:entity.enderman.teleport player @s ~ ~ ~ 1 1
    execute unless block ^ ^ ^0.7 #useful_tools:no_collision run particle minecraft:portal ~ ~0.5 ~ 0.25 0.5 0.25 0 100 normal @s
