...
# ブロック設置
    ...
    execute unless entity @s[x_rotation=90] positioned ^ ^ ^2 align xyz positioned ~0.5 ~0.5 ~0.5 run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.25 0.5 0.25 0 10
    ...
    execute if entity @s[x_rotation=90] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run particle minecraft:dust{color:[1,1,1],scale:1} ~ ~ ~ 0.25 0.5 0.25 0 10
